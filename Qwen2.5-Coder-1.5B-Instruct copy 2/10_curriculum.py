...
def main():
    ...
    # Let's evaluate 15 unseen problems to build our mini-curriculum
    num_problems = 15
    dataset = load_dataset("openai_humaneval", split=f"test[50:65]")
    ...
    for idx, adv in enumerate(adversarial_bank[:5]):
