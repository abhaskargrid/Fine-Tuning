...
def run_in_sandbox(generated_code: str, test_code: str) -> str:
    ...
    try:
        ...
        # <--- CHANGED: We now listen for the new WRONG_OUTPUT_ERROR from the sandbox
        if result.returncode == 0:
            return "SUCCESS"
        elif "TIMEOUT_ERROR" in result.stderr:
            return "TIMEOUT"
        elif "WRONG_OUTPUT_ERROR" in result.stderr:
            return "WRONG_OUTPUT"
            ...
            # <--- CHANGED: This is now just for silent system crashes
